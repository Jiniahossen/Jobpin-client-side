                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form className="card-body" onSubmit={handleRegister}>
                            ...
                            <div className="text-base font-serif">
                                <h2>Already have an account? <span className=" text-[#b50b82]"> <Link to={'/login'}>Login</Link></span></h2>
                            </div>
                            <div className="form-control mt-6">
                                <button className="bg-[#b50b82] btn text-white hover:bg-[#b50b82] hover:text-white">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
